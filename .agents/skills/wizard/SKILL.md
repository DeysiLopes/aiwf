...
argument-hint: "Manual procedure to wizard-ify"
---
...
- Never hand-edit the template library above the `STAGES` marker.
- Never invent steps that may not exist; ask the user or check the docs.
- Don't run the wizard end-to-end yourself (it blocks on human input) — trace it statically instead.